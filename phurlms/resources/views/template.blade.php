      ...
      <div class="col">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          <div class="container-fluid">
            <a class="navbar-brand" href="#">PhurLMS</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('professors.index') ? 'active' : '' }}" href="{{ route('professors.index') }}">Professors</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('professors.create') ? 'active' : '' }}" href="{{ route('professors.create') }}">Add Professor</a>
                </li>
              </ul>
            </div>
          </div>
